      ...
      <div class="
        ...
        <nav class="flex h-full flex-1 flex-col space-y-1 p-2">
          ...
          <a v-if="questions && questions.length" @click="clearStorage()" class="
            ...
            </svg>{{ isTrue ? "Dark" : "Light" }} mode</a><a href="https://discord.gg/openai" target="_blank" class="
              flex
              py-3
              px-3
              items-center
            ...
            </svg>OpenAI Discord</a><a href="https://help.openai.com/en/collections/3742473-chatgpt" target="_blank"
            class="
              flex
              py-3
              px-3
